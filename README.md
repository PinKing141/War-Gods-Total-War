...
> **Status**: Phases 1–10 Complete ✓ | Living Chronicle Phase 8 (Observer tool / dashboard) — Initial chronicle-reader tab ✓
...
See [docs/roadmaps/README.md](docs/roadmaps/README.md) for the roadmap reading order. Current focus: **Living Chronicle Phase 8 — Observer tool / dashboard** (initial chronicle-reader tab complete; timeline, army inspection, export buttons, and richer dashboard navigation remain future work).
