/* Archived procedural political map on <canvas>.
   This is available only for the optional ?oldMap debug path. Normal gameplay
   uses map_base.js + map_layers.js and the unique-RGB province map.
...
(function () {
  ...
  window.WG = window.WG || {};
  window.WG.ProceduralWorldMap = ProceduralWorldMap;
})();
